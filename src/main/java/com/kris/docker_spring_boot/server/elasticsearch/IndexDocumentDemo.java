...
public class IndexDocumentDemo {
    ...
    public static void main(String[] args) {
        try (RestHighLevelClient client = com.kris.docker_spring_boot.server.elasticsearch.InitDemo.getClient()) {
            // 1、创建索引请求
             ...
             * jsonMap.put("user", "kimchy"); jsonMap.put("postDate", new
             * Date()); jsonMap.put("message", "trying out Elasticsearch");
             ...
             * builder.startObject(); { builder.field("user", "kimchy");
             * builder.field("postDate", new Date()); builder.field("message",
             * "trying out Elasticsearch"); } builder.endObject();
            ...
            // 异步方式发送索引请求
            /*
             * ActionListener<IndexResponse> listener = new
