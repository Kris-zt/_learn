...
public class CreateIndexDemo {
    ...
    public static void main(String[] args) {
        try (RestHighLevelClient client = com.kris.docker_spring_boot.server.elasticsearch.InitDemo.getClient()) {
            ...
            // 5.1 异步方式发送请求
            /*
             * ActionListener<CreateIndexResponse> listener = new
             * ActionListener<CreateIndexResponse>() {
             * @Override public void onResponse( CreateIndexResponse
             * createIndexResponse) { // 6、处理响应 boolean acknowledged =
             * createIndexResponse.isAcknowledged(); boolean shardsAcknowledged
